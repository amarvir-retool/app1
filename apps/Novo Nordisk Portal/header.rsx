<Frame
  ...
  padding="8px 12px"
  sticky={true}
  style={{ map: { "primary-surface": "#051960" } }}
  type="header"
>
  <Image
    id="image1"
    ...
    margin="0"
    retoolStorageFileId="640112f5-bec5-40f4-b429-08383417ec2c"
  ...
  <Navigation
    ...
    retoolStorageFileId="86169efe-d066-4922-bce4-30027fcc525b"
    screenTargetByIndex=""
    ...
    style={{ map: { color: "surfacePrimary" } }}
    tooltipByIndex=""
  >
    <Option
      id="00031"
...
"
    ...
    <Option
      ...
      iconPosition="left"
      itemType="page"
      key="52e5da02-b5c4-4575-9c8f-c2828f3e5852"
      label="Action Centre"
      screenTargetId="ActionCentre"
    />
    <Option
      id="00030"
  ...
  <Avatar
    ...
    style={{ background: "automatic", caption: "surfacePrimary" }}
  />
</Frame>
