...
>
  ...
  >
    ...
    <Event
      ...
      method="trigger"
      params={{}}
      pluginId="sendUpdateNotification"
      type="datasource"
      waitMs="0"
      waitType="debounce"
    />
...
Batch {{ batchTable.selectedRow.nn_batch }} with ID:{{ batchTable.selectedRow.id }} has been updated by {{ current_user.fullName }}."
  ...
  >
    <Event
      ...
      method="trigger"
      params={{}}
      pluginId="sendInvestigatioNotification"
      type="datasource"
      waitMs="0"
      waitType="debounce"
    />
  ...
  <OpenAPIQuery
    id="sendInvestigatioNotification"
    isMultiplayerEdited={false}
    method="post"
    operationId="teams_channels_CreateMessages"
    parameterDynamicStates={'{"team-id":false,"channel-id":false}'}
    parameterMetadata={
      '{"team-id":{"label":"Default Directory"},"channel-id":{"label":"amarvir-demo-teams"}}'
    }
    parameters={
      '{"team-id":"26f28dd9-ef62-4f0e-beef-d6c250ec6468","channel-id":"19:70a0e45ef22446779f96f434a3ddf8b4@thread.tacv2"}'
    }
    path="/teams/{team-id}/channels/{channel-id}/messages"
    requestBody={
      '{"body":{"content":"An investigation for batch {{ batchTable.selectedRow.nn_batch }} with ID:{{ batchTable.selectedRow.id }} has been raised."}}'
    }
    requestBodyDynamicStates={
      '{"attachments":false,"body":false,"channelIdentity":false,"chatId":false,"createdDateTime":false,"deletedDateTime":false,"etag":false,"eventDetail":false,"from":false,"importance":false,"lastEditedDateTime":false,"lastModifiedDateTime":false,"locale":false,"mentions":false,"messageHistory":false,"messageType":false,"policyViolation":false,"reactions":false,"replyToId":false,"subject":false,"summary":false,"webUrl":false,"hostedContents":false,"replies":false,"@odata.type":false,"id":false}'
    }
    requestBodyMetadata=""
    resourceDisplayName="Amarvir MS Teams"
    resourceName="b4d27f3e-2a5b-4388-9d0b-78c203603986"
  />
