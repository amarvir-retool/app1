<Frame
  ...
  padding="8px 12px"
  sticky={true}
  style={{ map: { "primary-surface": "#0f2cf5" } }}
  type="header"
>
  <Navigation
    id="navigation1"
    ...
    retoolStorageFileId="99e99df7-98b0-479d-8019-94f23ca94feb"
    screenTargetByIndex=""
  ...
  >
    ...
    <Option
      ...
      iconPosition="left"
      itemType="page"
      label="Entitlement Lost"
      parentKey="1fe58"
      screenTargetId="entitlementLost"
    />
    <Option
      id="af011"
      disabled={false}
